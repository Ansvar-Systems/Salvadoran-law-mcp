...
**Endpoint:** `https://mcp.ansvar.eu/law-sv/mcp`

| Client | How to Connect |
|--------|---------------|
| **Claude.ai** | Settings > Connectors > Add Integration > paste URL |
| **Claude Code** | `claude mcp add salvadoran-law --transport http https://mcp.ansvar.eu/law-sv/mcp` |
...
```json
{
  "mcpServers": {
    "salvadoran-law": {
      "type": "url",
      "url": "https://mcp.ansvar.eu/law-sv/mcp"
    }
  }
}
```
