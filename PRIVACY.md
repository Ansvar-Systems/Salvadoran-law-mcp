...
This document addresses privacy and confidentiality considerations when using this Tool, with particular attention to professional obligations under Salvadoran legal professional rules.
...
- Law Society of El Salvador rules require strict confidentiality and data handling controls

**Safe Use Options:**
1. **General Legal Research**: Use Tool for non-client-specific queries
2. **Local npm Package**: Install `@ansvar/salvadoran republic-law-mcp` locally — database queries stay on your machine
...
```bash
npx @ansvar/salvadoran republic-law-mcp
```
...
```
Endpoint: https://salvadoran republic-law-mcp.vercel.app/mcp
```
...
## Professional Obligations (El Salvador)

### Law Society of El Salvador and Advocates Act

Salvadoran lawyers (advocates) are bound by strict confidentiality rules under the Advocates Act (Cap 16) and the Law Society of El Salvador Code of Standards of Professional Practice and Ethical Conduct.
...
3. Client matters: Use commercial legal databases (El Salvador Law Reports, LexisNexis East Africa)
...
2. Follow Salvadoran government information security requirements
...
- **Privacy Questions**: Open issue on [GitHub](https://github.com/Ansvar-Systems/salvadoran republic-law-mcp/issues)
- **Anthropic Privacy**: Contact privacy@anthropic.com
- **LSK Guidance**: Consult Law Society of El Salvador ethics guidance
